                ...
                <table class=" table table-bordered table-hover" style="margin-top:2%;">
                    ...
                    <tbody id="get_product">
                     <!--<tr>
                            ...
                            <td>
                                <a href="#" class="btn btn-danger btn-sm del_product">Delete</a>
                                <a href="#" class="btn btn-primary btn-sm edit_product">Edit</a>
                            </td>
                        </tr>-->
                    </tbody>
                </table>
...
<?php
include_once("templates/updateproductmodal.php");
?>
<!-- add update category Modal starts-->
